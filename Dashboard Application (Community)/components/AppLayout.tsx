...
const navigationItems = [
  {
    ...
    items: [
      ...
      { title: "클럽 관리", icon: Building2, id: "management" },
      { title: "신규 클럽 등록", icon: Plus, id: "registration" },
    ]
  },
  {
    title: "분석 & 보고서",
  ...
  },
  {
    title: "시스템",
    items: [
      { title: "종목 관리", icon: Trophy, id: "sports" },
      { title: "부서 관리", icon: Briefcase, id: "departments" },
      { title: "라이선스 관리", icon: Award, id: "licenses" },
      { title: "포지션 관리", icon: Target, id: "positions" },
  ...
  },
  {
    title: "테스트 관리",
    items: [
      { title: "테스트 정의", icon: TestTube, id: "tests" },
      { title: "테스트 세션", icon: Calendar, id: "test-sessions" },
    ]
  }
]
          ...
          <SidebarContent>
            ...
            <div className="p-6 border-b">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-semibold text-foreground">스포츠 클럽</h2>
